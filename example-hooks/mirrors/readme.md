...
It can be used for authenticating to upstream registries since ContainerD 2.2.0 no longer supports authenticating to registries via their config file.
...
It also expects the following variable to be set at the proxy scope: `mirror_config_path`.
